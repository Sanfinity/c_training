/*
 * Topic 33: Firmware Building Blocks -- PRACTICE TEMPLATE
...
led_state_t fsm_step_switch(led_state_t s, led_event_t e) {
    /* TODO: implement. HINT: switch on the state, then branch on the event to pick the next state. */
    return S_OFF; /* placeholder */
}
...
led_state_t fsm_step_table(led_state_t s, led_event_t e) {
    /* TODO: implement. HINT: build a static const table[state][event]; bounds-check s and e, then index it. */
    return S_OFF; /* placeholder */
}
...
bool rb_put(RingBuffer *rb, uint8_t v) {
    /* TODO: implement. HINT: reject when full; else store v at head, advance head % RB_SIZE, set full if head now equals tail. */
...
bool rb_get(RingBuffer *rb, uint8_t *out) {
    /* TODO: implement. HINT: reject when empty; else read tail into *out, advance tail % RB_SIZE, clear the full flag. */
    return false; /* placeholder */
}
...
unsigned sched_tick(Task *tasks, size_t n) {
    /* TODO: implement. HINT: for each task decrement countdown; on reaching 0 bump runs, reload from period, tally it as fired. */
...
bool debounce_update(Debounce *d, bool raw) {
    /* TODO: implement. HINT: shift raw into the 8-bit history; flip the stable level only on all-ones (0xFF) or all-zeros (0x00). */
    return false; /* placeholder */
}
...
uint8_t crc8(const uint8_t *data, size_t len) {
    /* TODO: implement. HINT: XOR each byte into crc, then 8x: shift left and XOR poly 0x07 whenever the top bit was set. */
    return 0; /* placeholder */
}
...
uint16_t crc16_ccitt(const uint8_t *data, size_t len) {
    /* TODO: implement. HINT: init 0xFFFF; XOR each byte into the HIGH byte, then 8x: shift left and XOR poly 0x1021 on carry-out. */
    return 0; /* placeholder */
}
...
q16_t to_fixed(double x) {
    /* TODO: implement. HINT: scale x by Q_ONE (2^Q_SHIFT) and round to the nearest integer. */
    return 0; /* placeholder */
}

/* P10: convert a Q16.16 value back to a real number. */
double from_fixed(q16_t v) {
    /* TODO: implement. HINT: the inverse of to_fixed -- divide v by Q_ONE in floating point. */
...
q16_t fx_mul(q16_t a, q16_t b) {
    /* TODO: implement. HINT: multiply in 64-bit to avoid overflow, then shift right by Q_SHIFT. */
    return 0; /* placeholder */
}
...
evt_group_t evt_set(evt_group_t *grp, uint32_t mask) {
    /* TODO: implement. HINT: OR the mask into *grp, then return the new *grp value. */
    return 0; /* placeholder */
}

/* P13: wait-any -- true if ANY bit in 'mask' is currently set in the group. */
bool evt_wait_any(evt_group_t grp, uint32_t mask) {
    /* TODO: implement. HINT: AND the group with the mask and test whether the result is non-zero. */
    return false; /* placeholder */
}
